...
# Safely get total_vram - handle case where CUDA is not available during import
try:
    total_vram = get_total_memory(get_torch_device()) / (1024 * 1024)
except (RuntimeError, AttributeError):
    # CUDA not available or device not accessible - will be set properly after initialization
    total_vram = 0
